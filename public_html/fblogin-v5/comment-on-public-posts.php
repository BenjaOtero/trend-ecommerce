...
define('APP_URL', 'http://localhost/Ecommerce/trunk/public_html/fblogin-v5/comment-on-public-posts.php');
...
if (isset($accessToken)) {
	...
	//$loginUrl = $helper->getLoginUrl(APP_URL, $permissions);
        $loginUrl = $helper->getLoginUrl('http://localhost/Ecommerce/trunk/public_html/fblogin-v5/comment-on-public-posts.php', $permissions);
	echo '<a href="' . $loginUrl . '">Log in with Facebookssss!</a>';
}