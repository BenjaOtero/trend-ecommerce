...
<div id="dvContacto" class="left-column-6">
    ...
    <form id="frmContacto" name="frmContacto" action="" method="post">
        ...
        <input id="txtNombre" class="textbox" type="text" />
        <p>E-mail<font>&nbsp;*</font></p>
        <input id="txtMail" class="textbox" type="text" />
        <p>Telefono</p>
        <input id="txtTe" class="textbox" type="text" />
        <p>Comentarios<font>&nbsp;*</font></p>
